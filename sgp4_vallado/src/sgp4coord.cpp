...
void teme2ecef(const double rteme[3], const double vteme[3], double jdut1, double recef[3], double vecef[3])
{
    double gmst;
    double st[3][3];
    double rpef[3];
...
void ijk2ll(const double r[3], double latlongh[3])
{
    double twoPI = 2.0*PI;
...
void rv2azel(const double ro[3], const double vo[3], double latgd, double lon, double alt, double jdut1, double razel[3], double razelrates[3])
{
    //Locals
